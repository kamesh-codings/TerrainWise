/**
 * =============================================================================
 * Terrain Wise - SOS Emergency Email Automation Service
 * =============================================================================
...
<head>
  ...
  <title>Terrain Wise Emergency SOS Alert</title>
  <style>
    body {
...
<body>
  <div class="container">
    <div class="header">
      ...
      <p>Immediate Assistance Requested via Terrain Wise Safety Platform</p>
    </div>

    <div class="content">
      <div class="alert-box">
        <strong>Hello ${recipientName || 'Trusted Contact'},</strong><br>
        This is an automated emergency broadcast from Terrain Wise. Traveler <strong>${traveler.name || 'A registered user'}</strong> has triggered an SOS Distress Beacon and requires immediate assistance.
      </div>
    ...
    <div class="footer">
      This is an automated safety alert generated by Terrain Wise Tourism Platform.<br>
...
function buildEmergencyEmailText({
  ...
  return `
🚨 TERRAIN WISE EMERGENCY SOS DISTRESS ALERT 🚨
====================================================
...
This is an automated emergency broadcast from Terrain Wise.
...
async function sendSingleSosEmail({
  ...
  const mailOptions = {
    from: `"Terrain Wise Emergency Safety Hub" <${senderEmail}>`,
    to,
    subject: `🚨 Terrain Wise SOS Alert: Immediate Assistance Required for ${traveler.name || 'Traveler'}`,
    text,
    html,
    priority: 'high',
    headers: {
